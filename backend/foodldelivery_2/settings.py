"""
Django settings for foodldelivery_2 project.
...
ROOT_URLCONF = 'foodldelivery_2.urls'
...
WSGI_APPLICATION = 'foodldelivery_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "FoodlDelivery Support <support@foodldelivery-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "foodldelivery_2 API",
    "DESCRIPTION": "API documentation for foodldelivery_2 App",
    "VERSION": "v1",
}
